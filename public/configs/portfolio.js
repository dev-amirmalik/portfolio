const projects = [
  {
    ...
    images: [
      `/assets/img/portfolio/xtremax-revamp/1.png`,
      `/assets/img/portfolio/xtremax-revamp/2.png`,
    ],
  ...
  {
    mainImageUrl: "/assets/img/portfolio/nt-cmp/1.png",
    images: [`/assets/img/portfolio/nt-cmp/1.png`],
  ...
  {
    mainImageUrl: "/assets/img/portfolio/xbase-template/1.png",
    images: [`/assets/img/portfolio/xbase-template/1.png`],
    title: "XBase",
    shortDescription:
  ...
  {
    mainImageUrl: "/assets/img/portfolio/pupr-bim/1.png",
    images: [`/assets/img/portfolio/pupr-bim/1.png`],
    title: "PUPR BIM Dashboard",
    shortDescription: "The portal to monitor the progress of the site project",
    mainDescription: "The portal to monitor the progress of the site project.",
    url: "",
  ...
  {
    mainImageUrl: "/assets/img/portfolio/pupr-ikn/1.png",
    images: [`/assets/img/portfolio/pupr-ikn/1.png`],
  ...
  {
    mainImageUrl: "/assets/img/portfolio/pixbox/1.png",
    images: [`/assets/img/portfolio/pixbox/1.png`],
    title: "Pixbox",
    shortDescription: "Cargo Web App tracking",
    mainDescription: "Cargo Web App tracking",
    url: "",
    tech: "Vuejs, Vuex, Microservice, Micro-frontend, HTML5, CSS3, SCSS, javascript",
    projectRole: "Frontend Developer",
  ...
  {
    mainImageUrl: "/assets/img/portfolio/pupr-sitaba/1.png",
    images: [`/assets/img/portfolio/pupr-sitaba/1.png`],
    title: "PUPR Sitaba",
    shortDescription:
  ...
  {
    mainImageUrl: "/assets/img/portfolio/mas-ba/1.png",
    images: [`/assets/img/portfolio/mas-ba/1.png`],
  ...
  {
    mainImageUrl: "/assets/img/portfolio/nimbus-stream/1.png",
    images: [`/assets/img/portfolio/nimbus-stream/1.png`],
    title: "NIMBUS Stream",
    shortDescription:
  ...
  {
    mainImageUrl: "/assets/img/portfolio/gcci-cmp/1.png",
    images: [`/assets/img/portfolio/gcci-cmp/1.png`],
  ...
  {
    mainImageUrl: "/assets/img/portfolio/csa-singcert/1.png",
    images: [`/assets/img/portfolio/csa-singcert/1.png`],
  ...
  {
    mainImageUrl: "/assets/img/portfolio/csa-gso/1.png",
    images: [`/assets/img/portfolio/csa-gso/1.png`],
    title: "GSO (Part of CSA Project)",
    shortDescription: "Web portal as marketing site for GSO part of CSA Gov SG",
    mainDescription: "Web portal as marketing site for GSO part of CSA Gov SG",
    url: "",
    tech: "HTML5, CSS3, SCSS, javascript, jQuery",
    projectRole: "Frontend Developer",
  ...
  {
    mainImageUrl: "/assets/img/portfolio/csa-portal/1.png",
    images: [`/assets/img/portfolio/csa-portal/1.png`],
    title: "CSA (Cyber Security Agency of Singapore) Portal",
    shortDescription: "Web portal as marketing site for CSA Gov SG",
    mainDescription: "Web portal as marketing site for CSA Gov SG",
  ...
  {
    mainImageUrl: "/assets/img/portfolio/nhb-portal/1.png",
    images: [`/assets/img/portfolio/nhb-portal/1.png`],
    title: "NHB (National Heritage Board) Portal",
    shortDescription: "Web portal as marketing site for NHB Gov SG",
    mainDescription: "Web portal as marketing site for NHB Gov SG",
  ...
  {
    mainImageUrl: "/assets/img/portfolio/cimb-moviz/1.png",
    images: [
      `/assets/img/portfolio/cimb-moviz/1.png`,
      `/assets/img/portfolio/cimb-moviz/2.png`,
    ],
    title: "CIMB Niaga Mofiz",
    shortDescription: "Mobile Applications for leave permissions, memos, etc",
    mainDescription:
  ...
  {
    mainImageUrl: "/assets/img/portfolio/insing-movie/1.png",
    images: [
      `/assets/img/portfolio/insing-movie/1.png`,
      `/assets/img/portfolio/insing-movie/2.png`,
    ],
    title: "InSing Movie",
    shortDescription:
  ...
  {
    mainImageUrl: "/assets/img/portfolio/jba-car/1.png",
    images: [
      `/assets/img/portfolio/jba-car/1.png`,
      `/assets/img/portfolio/jba-car/2.png`,
    ],
    title: "Car Inspection System",
    shortDescription: "Android app for car inspection",
    mainDescription:
  ...
  {
    mainImageUrl: "/assets/img/portfolio/jba-bike/1.png",
    images: [
      `/assets/img/portfolio/jba-bike/1.png`,
      `/assets/img/portfolio/jba-bike/2.png`,
    ],
    title: "Bike Inspection System",
    shortDescription: "Android app for bike inspection",
    mainDescription:
  ...
  {
    mainImageUrl: "/assets/img/portfolio/hgw-app/1.png",
    images: [
      `/assets/img/portfolio/hgw-app/1.png`,
      `/assets/img/portfolio/hgw-app/2.png`,
    ],
    title: "HungryGoWhere",
    shortDescription:
  ...
  {
    mainImageUrl: "/assets/img/portfolio/skyark-portal/1.png",
    images: [
      `/assets/img/portfolio/skyark-portal/1.png`,
      `/assets/img/portfolio/skyark-portal/2.png`,
      `/assets/img/portfolio/skyark-portal/3.png`,
    ],
    title: "SKY ARK",
    shortDescription:
  ...
  {
    mainImageUrl: "/assets/img/portfolio/wgea-portal/1.png",
    images: [
      `/assets/img/portfolio/wgea-portal/1.png`,
      `/assets/img/portfolio/wgea-portal/2.png`,
    ],
    title: "WGEA",
    shortDescription:
  ...
  {
    mainImageUrl: "/assets/img/portfolio/bc-sophie/1.png",
    images: [`/assets/img/portfolio/bc-sophie/1.png`],
  ...
  {
    mainImageUrl: "/assets/img/portfolio/solatip-app/1.png",
    images: [
      `/assets/img/portfolio/solatip-app/1.png`,
      `/assets/img/portfolio/solatip-app/2.png`,
    ],
    title: "Solatip",
    shortDescription: "Develop Android App for Solatip E-Commerce",
    mainDescription:
  ...
  {
    mainImageUrl: "/assets/img/portfolio/temploy-app/1.png",
    images: [
      `/assets/img/portfolio/temploy-app/1.png`,
      `/assets/img/portfolio/temploy-app/2.png`,
    ],
    title: "Temploy",
    shortDescription: "Android app that matches part time workers to employers",
    mainDescription:
